...
Requires [Fabric Loader](https://fabricmc.net) 0.19.3+ and [Fabric API](https://modrinth.com/mod/fabric-api) for 26.2. Textures are programmatic purple recolors of vanilla textures and (for the machines) of MIT-licensed [TechReborn](https://github.com/TechReborn/TechReborn) art — see `tools/gen-textures.js` and [CREDITS.md](CREDITS.md); derivative art, fine inside a Minecraft mod, but not original artwork.
