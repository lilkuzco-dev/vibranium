...
/**
 * A sword that runs a kinetic strike cycle. The metal is entirely in the profile and the
 * item properties, so vibranium and godite are the same class with different numbers.
 */
public class KineticSwordItem extends Item implements KineticCycleWeapon {
	private final KineticProfile profile;

	public KineticSwordItem(Properties properties, KineticProfile profile) {
		super(properties);
