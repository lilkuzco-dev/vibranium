 ...
 * properties — see VibraniumItems) plus the kinetic strike cycle shared with the
 * sword and axe.
 */
public class VibraniumSpearItem extends Item implements KineticCycleWeapon {
	public VibraniumSpearItem(Properties properties) {
		super(properties);
	}
